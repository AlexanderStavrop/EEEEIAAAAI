...
fprintf('Part Β_1 (FisherIris): Loading the dataset.\n');
...
fprintf('Part Β_2 (FisherIris): Normalizing data.\n');
...
fprintf('Part Β_3 (FisherIris): Visualizing data.\n');
%  Visualize the example dataset
...
hold off
% print('~/Desktop/ex1_3_fisherIris_normal', '-depsc')

%% ====================== PART B_4: Label extraction ====================
fprintf('Part Β_4 (FisherIris): Loading the data data.\n');
...
%% ======================= PART B_6: Visualization =====================
%  Visualize the example dataset
figure('Name','FisherIris DATA Normalized');
title('Normilized FisherIris DATA')
hold on
plot(IRIS1(:, 1), IRIS1(:, 2), 'bo');
plot(IRIS2(:, 1), IRIS2(:, 2), 'rs');
plot(IRIS3(:, 1), IRIS3(:, 2), 'g+');
...
%% =============== PART B_4: Apply LDA to Fisher Iris Dataset ===============
