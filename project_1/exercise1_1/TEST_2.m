...
figure('Name','Load Example Dataset');
...
figure('Name', 'Normalized Features');
...
figure('Name','Principal Component Analysis (Part 1)');
plot(X_norm(Y==0, 1), X_norm(Y==0, 2), 'bo',X_norm(Y==1, 1), X_norm(Y==1, 2), 'ro' );
hold on
...
figure('Name','Principal Component Analysis (Part 2)');
hold on
...
K = 1;
Z = projectData(X_norm, eigvecs, K);                 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% PROJECT WAS 1
...
figure('Name','Dimensionality Reduction');
hold on;
...
title('PCA sample projections ex');
...
% Projection of the data onto the principal components
X_PCA = projectData(X_norm, eigvecs, 2);                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% PROJECT was k=2

% Plot the samples on the first two principal components
figure('Name','Perform PCA on all features in the dataset 2');
